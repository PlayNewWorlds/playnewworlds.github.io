...
func gravity(
	satellite_position: Vector2, parent_position: Vector2, parent_mass: float = 1
) -> Vector2:
...
func _physics_process(delta: float) -> void:
	...
	var delta_v: Vector2
	for parent_body in [
		[1, get_node("/root/Game/World1").global_position],
		[0.2, get_node("/root/Game/World1/Moon1").global_position]
	]:
	...
	# TODO: This information should be set to the CharacterBody properties
	# instead of arguments: snap, Vector2.DOWN, Vector2.UP
